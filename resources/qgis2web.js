...
map.getView().fit([-9620554.882992, 896454.099569, -9062342.948653, 1162825.976791], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa del metodo Terriori</h2>';
        return titleElement;
    })(),
